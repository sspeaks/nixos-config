...

{
  ...
  # XDG applications menu — required for Dolphin "Open With" to discover apps
  ...
  # Full BreezeDark color scheme for KDE apps (Dolphin, etc.)
  ...
  # Desktop entries for apps that need custom launchers
  ...
  # Override imv desktop entry — upstream sets NoDisplay=true hiding it from "Open With"
  ...
  # Default applications for common MIME types
  xdg.mimeApps = {
    enable = true;
    defaultApplications = {
